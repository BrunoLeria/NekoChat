...
<template>
    <!-- Sidebar -->
    <div
        class="flex-none xl:w-1/6 w-1/8 h-full min-w-min bg-indigo-700 auto-rows-max flex-none flex flex-col z-10">
        <div
            class="py-6 w-full bg-indigo-500 hover:bg-indigo-600 ease-in-out duration-500">
